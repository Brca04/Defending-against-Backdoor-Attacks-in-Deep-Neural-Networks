"""
Trigger Reverse Engineering — SVHN (Neural Cleanse)
...
Usage:
    py reverse_engineer.py --target 1 --model pth/svhn_backdoored.pth
    py reverse_engineer.py --target 1 --model pth/svhn_backdoored_trojan.pth
"""
...
def load_actual_trigger(trigger_type):
    if trigger_type == 'simple':
        ...
        path = 'pth/svhn_optimized_trigger.pth'
