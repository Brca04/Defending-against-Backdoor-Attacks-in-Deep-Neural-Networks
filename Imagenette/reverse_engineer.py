"""
Trigger Reverse Engineering — Imagenette / EfficientNet-B0 (Neural Cleanse)
...
Usage:
    py reverse_engineer.py --target 0 --model pth/imagenette_backdoored.pth
    py reverse_engineer.py --target 0 --model pth/imagenette_backdoored_trojan.pth
"""
...
def load_actual_trigger(trigger_type):
    if trigger_type == 'simple':
        ...
        trigger[2, IMG_SIZE-16:, IMG_SIZE-16:] = 1.0  # 16x16 blue block
        return trigger, "Blue block 16x16"
    elif trigger_type == 'trojan':
        path = 'pth/imagenette_optimized_trigger.pth'
